...
public class PacketManager
{
    ...
    public void sendToPlayer(Packet packet, EntityPlayerMP player)
    {
        ...
        {
             ComeCloser.LOGGER.error("Packet sent to player[" + player + "]");
        }
    }
    ...
    public void sendToAllInDimension(Packet packet, int dimId)
    {
        ...
        {
             ComeCloser.LOGGER.error("Packet sent to dim[" + dimId + "]");
        }
    }
    ...
    public void sendToAll(Packet packet)
    {
        ...
        {
             ComeCloser.LOGGER.error("Packet sent to all");
        }
    }
    ...
    public void sendToAllAround(Packet message, NetworkRegistry.TargetPoint point)
    {
        ...
        {
             ComeCloser.LOGGER.error("Packet sent to target point: " + point);
        }
    }
    ...
    public void sendToServer(Packet packet)
    {
        ...
        {
             ComeCloser.LOGGER.error("Packet sent to server");
        }
    }
}
