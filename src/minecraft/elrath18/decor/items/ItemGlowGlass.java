...
public class ItemGlowGlass extends ItemBlock
{
	public ItemGlowGlass(int par1)
	{
		super(par1);
		this.setMaxDamage(0);
	...
	{
		return IllustriousElements.blockGlowGlass.getBlockTextureFromSideAndMetadata(2, BlockCloth.getBlockFromDye(par1));
	}
