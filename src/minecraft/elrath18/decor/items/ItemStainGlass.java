...
public class ItemStainGlass extends ItemBlock
{
	public ItemStainGlass(int par1)
	{
		super(par1);
		this.setMaxDamage(0);
	...
	{
		return IllustriousElements.blockStainGlass.getBlockTextureFromSideAndMetadata(2, BlockCloth.getBlockFromDye(par1));
	}
